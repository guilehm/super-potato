    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_patients', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_professionals', to=settings.AUTH_USER_MODEL)),
                ...
                ('procedures', models.ManyToManyField(related_name='professionals', to='attendance.Procedure')),
            ],
            options={
                'abstract': False,
            },
